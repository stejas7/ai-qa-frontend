...
const nav=[['Home','/'],['Start UAT','/mission'],['Results','/dashboard'],['Execution','/execution'],['Performance','/performance'],['Automation','/automation-scripts'],['Test Management','/test-management'],['Knowledge','/knowledge']] as const;
