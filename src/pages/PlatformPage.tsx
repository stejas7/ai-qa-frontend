...
export default function PlatformPage(){
 ...
 const companyRows=companies.data??[];const productRows=products.data??[];const userRows=users.data??[];const operationRows=operations.data??[];
 ...
 const completed=operationRows.filter(o=>o.status==='COMPLETED').length;
 ...
 return <main className="page"><div className="eyebrow">4.0 • M20.1–M20.4</div><h1>Platform Owner Reporting</h1><p className="lead">Read-only cross-tenant oversight for company adoption, product footprint, user access and autonomous UAT operations. No passwords, credential references or secret values are exposed.</p>
