...
const future=[
['Requirement-driven QA','Provide a complete business requirement and UAT target; Auravis owns the downstream flow with minimal manual intervention.'],
...
<div className="eyebrow">KNOWLEDGE • REAL-WORLD VALUE</div><h1>What problem is Auravis trying to solve?</h1><p className="lead">Business requirements often pass through several manual QA hand-offs before teams know whether a release actually satisfies the intended behavior. Auravis explores an autonomous, explainable UAT workflow with strong Java controls and evidence at every step.</p>
...
Regression re-run
↓
Release recommendation</pre></article><article className="panel future-panel"><div className="eyebrow">AURAVIS TARGET STATE</div><h2>Autonomous UAT flow</h2><pre className="text-flow">Business Requirement / UAT Target
↓
