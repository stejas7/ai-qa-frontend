...
export default function NewMissionPage(){
  ...
  return <main className="page"><div className="eyebrow">AUTONOMOUS UAT</div><h1>Start UAT</h1><p className="lead">Upload a BRD, PRD, user story or requirement document. AI UAT Engineer persists the mission in PostgreSQL and processes it through requirement intelligence, test design and supported UAT execution.</p>
    <section className="panel mission-form"><form onSubmit={submit}>
      ...
      <div className="form-actions"><button className="primary-btn" disabled={upload.isPending||!file}>{upload.isPending?'Starting UAT…':'Start UAT'}</button></div>
