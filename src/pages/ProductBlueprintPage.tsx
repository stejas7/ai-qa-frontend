...
const visualVersion='20260823-m100-v2';
const visuals = [
  ...
  { title: 'System architecture', subtitle: 'React + Nginx + Spring Boot + Spring AI + PostgreSQL + Playwright + durable evidence + AWS deployment + M100 governance layers', src: `/blueprint-architecture.svg?v=${visualVersion}` },
  ...
  { title: 'Database & traceability', subtitle: 'Tenant-safe data path from companies/users/products through missions, tests, executions, evidence, dependency memory, portfolio/workforce data, audit and release decisions', src: `/blueprint-database.svg?v=${visualVersion}` },
  { title: 'M1–M100 roadmap', subtitle: 'Foundation → enterprise/security → 100-agent workforce → adaptive intelligence → dependency/business journeys → portfolio/workforce → enterprise autonomy', src: `/blueprint-roadmap.svg?v=${visualVersion}` }
] as const;
