const groups = [
  ...
  ['M7 Intelligence Platform',['Controlled QA Tools','Spring AI RAG - integrating','pgvector - integrating','Regression Intelligence - next','NOVA Spring AI - next']],
...
export default function TechnologyPage(){return <main className="page">
  <div className="eyebrow">ENGINEERING SHOWCASE • AI UAT ENGINEER</div><h1>Technology Behind AI UAT Engineer</h1>
  ...
  <section className="panel portfolio-note"><strong>Spring AI is running now</strong><p className="muted">Requirement Intelligence and Failure Diagnosis use Spring AI ChatClient. M7 added controlled Spring AI tool calling over persisted AI UAT Engineer QA facts. RAG/pgvector and regression intelligence remain clearly marked as integration work until they are fully connected and verified.</p></section>
</main>}
