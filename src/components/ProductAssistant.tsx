...
async function askBackend(question:string){
  const response=await fetch('/api/product-guide/ask',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({question})});
